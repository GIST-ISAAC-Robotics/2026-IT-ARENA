...
#14 최신 공식 답변은 보유 물품을 별도 산입하지 않고 신규 구매만 집계한다고 명시했습니다. 따라서 보유 D435i 정가 포함을 걱정했던 가정은 현재 기준이 아닙니다. 신규 집계 상한 30만 원·모터/센서 가격 무관 집계 등의 [최신 규정](../reports/OFFICIAL_UPDATE_2026_09_15.md)을 우선합니다. 아래 제품 가격·ToF 수량 비교는 과거 후보이며 이번 규정 갱신이 최종 센서 채택·구매를 의미하지 않습니다.

## 2026-09-06 당시 비교 기준과 추천
