...
2026-09-04 추가 관찰: 스테레오 단독 주행 조정 중 도로–잔디 경계에 바퀴가
걸친 상태에서 차체가 정지하고 한쪽 뒷바퀴만 도는 사례를 기록했습니다.
명령 0.47165 m/s에 바퀴 평균도 약 0.47167 m/s였지만 차체 이동은 사실상
0이었습니다. [실행 보고서](../../artifacts/validation/2026-09-04/selectable_autonomy/stereo_brisk_one_lap_02_rgb_center_video/report.json)와
[실제 3인칭 프레임](../../artifacts/validation/2026-09-04/selectable_autonomy/stereo_brisk_one_lap_02_rgb_center_video/video_inspection/frame_01258.jpg)을
함께 봅니다. 실차도 같은 경계에서 반드시 멈춘다는 결과는 아니며, 서스펜션 없는
강체 차량·분할 노면 접촉·이상적 오픈 차동의 조합입니다. 접촉력/휠 하중을
별도 계측하기 전 구체적인 바퀴 들림 원인은 확정하지 않습니다.
