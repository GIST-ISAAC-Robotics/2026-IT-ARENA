...
확인일: 2026-08-31. 이 폴더의 주 검증 대상은 [이슈 #7의 등록 본문](../../../../docs/track/OFFICIAL_UPSTREAM_ISSUE_DRAFTS.md)입니다. 재현 자료와 정리 전 기록의 보관소이며, 현재 이슈 상태는 프로젝트 현황과 공식 자료 감사에서 관리합니다.
...
- 자료 정리 당시에는 모두 미게시였고, 이후 사용자의 명시적 승인으로 단일 보고를 [#7](https://github.com/MOSW626/istech-it-arena/issues/7)에 등록했습니다. 별도 후속 승인으로 보관 ZIP의 01·06·07·05 초안을 각각 [#8](https://github.com/MOSW626/istech-it-arena/issues/8)·[#9](https://github.com/MOSW626/istech-it-arena/issues/9)·[#10](https://github.com/MOSW626/istech-it-arena/issues/10)·[#11](https://github.com/MOSW626/istech-it-arena/issues/11)에 등록했습니다. 방지턱과 신호등 관찰은 [공식 자료 감사 §5](../../../../docs/track/OFFICIAL_SOURCE_AUDIT.md#5-공식-출력물-내부-불일치와-재현한-한계)에 미게시 상태로 유지합니다. 검증 JSON의 게시 전 상태와 원시 기록은 당시 사실로 그대로 보존합니다.
