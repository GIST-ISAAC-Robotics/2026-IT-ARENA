...
def _launch_setup(context):
    ...
    actions = [
        ...
        LogInfo(msg=f"2D LiDAR: enabled={lidar_enabled}; {lidar_rate_hz:g} Hz, "
                    ...
                    f"acquisition={LaunchConfiguration('lidar_acquisition').perform(context)}; source={LaunchConfiguration('lidar_source_rate_hz').perform(context)} Hz; capture quantization <=2.1 ms; no deskew."),
        gazebo_server,
        bridge,
        sensor_bridge,
        vehicle_interface,
...
def generate_launch_description() -> LaunchDescription:
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("render_backend", default_value="auto", choices=["auto", "system", "wsl_nvidia", "software"],
